                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="card mb-4 shadow">
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between flex-row py-3">
                            <h6 class="font-weight-bold text-primary m-0">Total Terapi Sepeda Cermin</h6>
                    ...
                    <div class="card mb-4 shadow">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-10 mx-10"><label class="labels">Riwayat Penyakit : Stroke kanan</label>
                                </div>
                            </div>
                        </div>
                    </div>
