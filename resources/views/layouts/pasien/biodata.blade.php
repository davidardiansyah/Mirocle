                ...
                <div class="p-3">
                    ...
                    <div class="row">
                        <div class="col-md-12"><label class="labels">Nama</label><input type="text" class="form-control"
                                placeholder="Masukan nama" value=""></div>
                        <div class="col-md-12"><label class="labels">Umur</label><input type="text" class="form-control"
                                placeholder="Masukan umur" value=""></div>
                        <div class="col-md-12"><label class="labels">Berat Badan</label><input type="text"
                                class="form-control" placeholder="Masukan berat badan" value=""></div>
                        <div class="col-md-12"><label class="labels">Jenis Kelamin</label><input type="text"
                                class="form-control" placeholder="Masukan jenis kelamin" value=""></div>
                        <div class="col-md-12"><label class="labels">Riwayat Penyakit</label><input type="text"
                                class="form-control" placeholder="Masukan riwayat penyakit" value=""></div>
